...
namespace ShareSmallBiz.Portal.Areas.Identity.Pages.Account
{
    public class LoginWithRecoveryCodeModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (result.Succeeded)
            {
                _logger.LogInformation("User with ID '{CreatedID}' logged in with a recovery code.", user.Id);
            ...
            {
                _logger.LogWarning("Invalid recovery code entered for user with ID '{CreatedID}' ", user.Id);
