...
namespace ShareSmallBiz.Portal.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            _logger.LogInformation("User with ID '{CreatedID}' has enabled 2FA with an authenticator app.", userId);
        ...
        private async Task LoadSharedKeyAndQrCodeUriAsync(ShareSmallBizUser user)
        {
