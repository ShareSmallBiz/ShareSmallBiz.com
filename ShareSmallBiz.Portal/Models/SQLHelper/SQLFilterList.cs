...
public class SQLFilterList : List<SQLFilterClause>
{
    ...
    public SQLFilterList(IEnumerable<SQLFilterClause> collection) : base(collection)
    {
    }
    private string SearchField;
    private bool FindClauseByField(SQLFilterClause FilterClause)
    {
    ...
    public List<SQLFilterClause> FindField(string reqSearchField)
    {
